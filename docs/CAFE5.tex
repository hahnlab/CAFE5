...
showing that 10% of the values were rejected due to saturation. In addition, individual families may either be saturated or be calculated with a probability so low it cannot be measured. If this occurs on more than 20% of the attempts, it also will be noted at the end of the run.
